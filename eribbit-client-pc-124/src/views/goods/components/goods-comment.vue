  ...
  <div class="goods-comment"  v-if="commentInfo">
    <div class="head">
      ...
      <div class="tags">
        ...
        <div class="dd">
          <a @click="changeTag(i)" v-for="(item,i) in commentInfo.tags" :key="item.title" href="javascript:;" :class="{active:currTagIndex===i}"> {{item.title}}（{{item.tagCount}}）</a>
        </div>
      </div>
    </div>
    <!-- 排序 -->
    ...
    <div class="list" v-if="commentInfo">
     <!-- 列表 -->
    <div class="list">
    ...
    <xtx-pagination @current-change="changePager" :total="total" :current-page="reqParams.page" />
  </div>
</template>
<script>
...
export default {
  ...
  setup () {
    ...
    return { commentInfo, currTagIndex, changeTag, reqParams, changeSort, formatSpecs, formatNickname, commentList, changePager }
  }
}
</script>
